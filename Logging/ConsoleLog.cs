...
internal static class ConsoleLog
{
    ...
    public static void Info(string message) => Console.WriteLine($"        {Redact(message)}");
    ...
    public static void Relay(string message) => Write(ConsoleColor.DarkGray, $"      | {Redact(message)}");

    public static void Success(string message) => Write(ConsoleColor.Green, $"        {Redact(message)}");

    public static void Warn(string message) => Write(ConsoleColor.Yellow, $"  warn  {Redact(message)}");
